...
#define list_for_each_it(var, list) \
	for ((var) = (list)->next; !list_same_node((var), list); (var) = (var)->next)

#define list_for_each(var, head, member)                         \
	for ((var) = list_first_entry(head, typeof(*(var)), member); \
		 !list_entry_is_head(var, head, member); (var) = list_next_entry(var, member))

#define list_for_each_safe_it(var, n, list)                                     \
	for ((var) = (list)->next, (n) = (var)->next; !list_same_node((var), list); \
		 (var) = (n), (n) = (var)->next)
